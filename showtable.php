	...
	<section class="services serve service-style2" id="features" >
		<div class="container">
			<div class="row">
						 ...
						 <div class="container-fluid" >
							<table style="margin: 0 auto;">
								<tr style="border-bottom: 2px solid white;">
									<th style="padding-right:200px;padding-bottom: 5px;">TIME</th>
									<th style="padding-right:200px;">FLIGHT NO.</th>
									<th style="padding-right:200px;">FROM</th>
	...
	<!--Modal starts-->
					...
					<form class="modal-content3 animate" action="/action_page.php">
						...
						<div class="container">
								  ...
								  <a href="arrivals2.php" class="insertbtn" style="text-decoration:none;background-color:white;color:#ef494d;margin-left: 20px !important;border:1px solid white;padding:10px;"><b>Insert</b></a>
								  <div><p style="font-size:25px;margin-left: 20px !important;"><b>Or you could search your flight to edit or delete!</b></p></div>
								  <a href="searchpagearrivals.php" style="text-decoration:none;background-color:white;margin-left: 20px !important;color:#ef494d;border:1px solid white;padding:10px;" class="insertbtn"><b>Edit</b></a>&nbsp;
								  <a href="searchdeletearrivals.php" style="text-decoration:none;background-color:white;color:#ef494d;border:1px solid white;padding:10px;" class="insertbtn"><b>Delete</b></a><br>
								</div>
								<br>
	...
	<br>
		<div class="row">
			<div class="col-lg-12" align="center">
				<button class="btn btn-lg btn-success center text-center" style="background-color: #ef494d;color: white;border: 2px solid #f4f4f4;border-radius: 12px;margin-bottom: 50px;" id="btnContactUs" onclick="document.getElementById('id01').style.display='block'">Manage</button>
			</div>
		</div>
	</div>
	<!-- Ends: .arrivaltable -->
	...
	<div class="row">
	<div class="col-sm-12">
	<h2 style="position: relative;font-size:  40px;">How to manage arrivals?</h2>

	<p style="
    position: relative;font-size: 22px;width:  1000px !important;">Please make sure when you enter the flight numbers and destinations, they must be in capital letters according to International Aviation Rules and please do keep in mind there are twelve gates with six blocks attached to it starting from A to F for a maximum at the airports. </p>
	</div>
	</div>
	</div>
	</section>
