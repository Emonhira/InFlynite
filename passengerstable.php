			...
			<div class="container">
                        ...
                        <div class="collapse navbar-collapse navbar-morki">
                            <ul class="nav navbar-nav navbar-right navbar-edit">
                                ...
                                <li><a href="start.php" class="loginButton" style="background-color:#ef494d;border-radius:6px;padding: 10px;">Back</a></li>		
							</ul>
                        </div><!-- .navbar-collapse -->		
			</div>
		</nav>
...
<section class="services service-style2" id="features">
	<div class="container">
		<div class="row">
			...
			<h2 class="featurehead">Passengers</h2>
			</div>

			<div class="col-md-12 col-sm-12">
				<div class="service-box4" style="width: 1300px;margin: 0 auto;border-radius: 10px;">
	 
	 <!--table-->
					 <div class="container-fluid" >
					<table class="passengers-table" style="margin: 0 auto;">
						  <tr style="border-bottom: 2px solid white;">
							<th style="padding-right:100px;padding-bottom: 5px;padding-left:50px;color: #ef494d;">Name</th>
							<th style="padding-right:50px;color: #ef494d;">Age</th>
							<th style="padding-right:200px;color: #ef494d;">Email</th>
							<th style="padding-right:100px;color: #ef494d;">Date</th>
							<th style="padding-right:100px;color: #ef494d;">Ticket Number</th>
							<th style="padding-right:100px;color: #ef494d;">Flight Number</th>
							<th style="padding-right:100px;color: #ef494d;">Flight Time</th>
							<th style="padding-right:100px;color: #ef494d;">Airlines</th>
							<th style="padding-right:100px;color: #ef494d;">To</th>
						  </tr>
						<?php include('passengerstable2.php');?>
					  </table>
					</div>
				</div>
			</div>
...
<div id="id01" class="modal">
					<form class="modal-content3 animate" action="/action_page.php">
						...
						<div class="container">
								  <h1 style="text-decoration:none;">Manage Passengers</h1>
								  <p style="font-size:25px;margin-left: 20px !important;"><b>Add a passenger info to the table!</b></p>
								  <a href="passengers2.php" class="insertbtn" style="text-decoration:none;background-color:white;color:#ef494d;margin-left: 20px !important;border:1px solid white;padding:10px;"><b>Insert</b></a>
								  <div><p style="font-size:25px;margin-left: 20px !important;"><b>Or you could search your flight to edit or delete!</b></p></div>
								  <a href="searchpagepassengers.php" style="text-decoration:none;background-color:white;margin-left: 20px !important;color:#ef494d;border:1px solid white;padding:10px;" class="insertbtn"><b>Edit</b></a>&nbsp;
								  <a href="searchdeletepassengers.php" style="text-decoration:none;background-color:white;color:#ef494d;border:1px solid white;padding:10px;" class="insertbtn"><b>Delete</b></a><br>
								</div>
								<br>
...
<div class="row">
    <div class="col-lg-12" align="center">
		<button class="btn btn-lg btn-success center text-center" id="btnContactUs" style="border-radius: 10px;" onclick="document.getElementById('id01').style.display='block'">Manage</button>
	</div>
</div>
</div>
</section>
<!-- Ends: .passengerstable-->
...
<div class="row">
<div class="col-sm-12">
<h2 style="position: relative;">How to manage passengers?</h2>

<p style="position: relative; font-size: 18px;">Please make sure you type in the exact passenger name, age, email, flight number, flight time, airlines and their destinations respectively. They must be precise according to the International Aviation Rules</p>
</div>
</div>
</div>
</section>
