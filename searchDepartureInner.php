			...
			<div class="container">
                        ...
                        <div class="collapse navbar-collapse navbar-morki">
                            <ul class="nav navbar-nav navbar-right navbar-edit">
                                ...
                                <li><a href="searchDepartureTable.php" class="loginButton" style="background-color:#ef494d;border-radius:6px;padding: 10px;">Back</a></li>		
							</ul>
                        </div><!-- .navbar-collapse -->		
			</div>
		</nav>
...
<section class="services service-style2" id="features">
	<div class="container">
		<div class="row">
            ...
            <br><br><br><br>
			<h2 class="featurehead"><?php echo $flight; ?></h2>
			</div>

			<div class="col-md-12 col-sm-12">
				<div class="service-box3">
					 <div class="container-fluid" >
							<div class="container" style="border: 8px solid #ef494d;background-color: #ef494d;border-radius: 25px;width: 900px;margin: 0 auto;">
                                <table style="margin: 0 auto;">
                                    <tr style="color:white !important;font-size:25px;">
                                        <th style='color:white !important;padding-right: 28px; !important;'>Flight Number</th>
                                        <th style='color:white !important;padding-right: 28px;'>Flight Time</th>
                                        <th style='color:white !important;padding-right: 28px;'>Destination</th>
                                        <th style='color:white !important;padding-right: 28px;'>Gate</th>
                                        <th style='color:white !important;padding-right: 28px;'>Flight Status</th>
                                    </tr>

                                    <?php
                                        $sql2 = "SELECT * FROM departures WHERE Flight_No='".$flight."'";
                                        $result2=mysqli_query($con,$sql2);

                                            if(mysqli_num_rows($result2)== 0){
                                                echo "<tr  style='color:white !important;font-size:25px;'>";
                                                echo "<td colspan='5' style='color:lightgrey !important;font-size:35px;padding-left:140px;'><i class='fa fa-close'></i> Flight ".$flight." Not Found</td>";
                                                echo "</tr>";
                                            }
                                        //echo "Record fetched successfully.<br>";
                                            while ($row = mysqli_fetch_array($result2)) {
                                                echo "<tr  style='color:white !important;font-size:25px;'>";
                                                echo "<td style='color:white !important;padding-right: 28px;'>".$row['Flight_No']."</td>";
                                                echo "<td style='color:white !important;padding-right: 28px;'>".$row['Flight_Time']."</td>";
                                                echo "<td style='color:white !important;padding-right: 28px;'>".$row['Destination']."</td>";
                                                echo "<td style='color:white !important;padding-right: 28px;'>".$row['Gate']."</td>";
                                                echo "<td style='color:white !important;padding-right: 28px;'>".$row['Flight_Status']."</td>";
                                                echo "</tr>";
                                            } 
...
<div class="row">
<div class="col-sm-12">
<h2 style="position:relative;">How to know about the flight?</h2>

<p style="position:relative;font-size:18px;">Get to know the flight information you need right here!</p>
</div>
</div>
</div>
</section>
