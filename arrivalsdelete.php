			...
			<div class="container">
                        ...
                        <div class="collapse navbar-collapse navbar-morki">
                            <ul class="nav navbar-nav navbar-right navbar-edit">
                                ...
                                <li><a href="showtable.php" class="loginButton" style="background-color:#ef494d;border-radius:6px;padding: 10px;">Back</a></li>		
							</ul>
                        </div><!-- .navbar-collapse -->		
			</div>
		</nav>
...
<?php
					...
					$originalFlightNo = $_POST['flight'];
					$sql="SELECT * FROM flights WHERE Flight_No='{$originalFlightNo}'";
...
<section class="services service-style2" id="features">
	<div class="container">
		<div class="row">
			...
			<h2 class="featurehead">Delete</h2>
			</div>
			...
			<div class="col-md-12 col-sm-12">
				<div class="service-box3">
					 <div class="container-fluid" >
							...
							<input type="text" placeholder="Enter flight number.." name="fano" value="<?php echo $originalFlightNo ?>" style="margin-left: 60px;border-radius: 5px;" required>
							  <br>
							  <label>TIME: </label>
							 <input type="text" placeholder="Enter flight time.." name="fatimes" value="<?php echo $time ?>" style="margin-left: 171px;border-radius: 5px;" required>
							  <br>
							<label>FROM: </label>
							<input type="text" placeholder="Enter flight arriving from.." value="<?php echo $destination ?>" style="border-radius: 5px;margin-left: 160px;" name="fadest" required>
							  <br>
							<label>GATE: </label>
							<input type="text" placeholder="Enter gate number" value="<?php echo $gate ?>" style="margin-left: 168px;border-radius: 5px;" name="fagate" required>
								<br>							  
							<label>FLIGHT STATUS: </label>
							<input type="text" placeholder="Enter flight status" value="<?php echo $flightStatus ?>" style="margin-left: 75px;border-radius: 5px;" name="fastatus" required>
							  <br><br>
							 <input type="hidden" placeholder="Original Flight No." value="<?php echo $originalFlightNo ?>" name="originalFlight" >

							  <h3 style="font-size:30px;font-family: Roboto;color:white;text-align:center;"><i class="fa fa-warning"></i>  Are you sure you want to delete? </h3><br>
							  <button type="submit" name="arrivalsend" class="savebtn" style="position:relative;top:-40px;margin-left:580px;">Delete</button>
							</div>								
								</form>
							</div>
                    </div>
...
<div class="row">
<div class="col-sm-12">
<h2 style="position:relative;">How to insert for Arrivals?</h2>

<p style="position:relative;font-size:18px;">Please fill up all the necessary fields shown above regarding the details of the flights arriving at Hazrat Shahjalal International Airport.</p>
</div>
</div>
</div>
</section>
