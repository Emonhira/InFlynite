			...
			<div class="container">
                        ...
                        <div class="collapse navbar-collapse navbar-morki">
                            <ul class="nav navbar-nav navbar-right navbar-edit">
                                ...
                                <li><a href="searchflight.php" class="loginButton" style="background-color:#ef494d;border-radius:6px;padding: 10px;">Back</a></li>		
							</ul>
                        </div><!-- .navbar-collapse -->		
			</div>
		</nav>
			...
			<div class="col-md-12 col-sm-12">
				<div class="service-box3">
					 <div class="container-fluid" >
							...
							<div class="dropdown">
							<form action="searchDepartureInner.php" method="POST">
						    <label style="margin-left:200px;">Flight No: </label>
							 <input style="margin-left:200px;" type="text" placeholder="Enter flight no.." name="flight" required>
							<br>
...
<div class="row">
<div class="col-sm-12">
<h2 style="position:relative;">How to look for your flight?</h2>

<p style="position:relative;font-size:18px;">Please enter your flight number to search the flight.</p>
</div>
</div>
</div>
</section>
