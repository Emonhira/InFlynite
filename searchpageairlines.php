			...
			<div class="col-md-12 col-sm-12">
				<div class="service-box3">
					 <div class="container-fluid" >
							...
							<div class="dropdown">
							<form action="airlinesupdate.php" method="POST">
							<br>
						    <label style="margin-left:300px;">Airline Name: </label>
							 <input style="margin-left:300px;" type="text" placeholder="Enter name.." name="aname" style="margin-left: 150px;"required>
							<br>
...
<div class="row">
<div class="col-sm-12">
<h2>How to look for airlines?</h2>

<p>Please enter the airline you are looking for to edit.</p>
</div>
</div>
</div>
</section>
