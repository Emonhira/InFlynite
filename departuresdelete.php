...
<ul class="nav navbar-nav navbar-right">
	...
	<li class="nav-download-btn"><a href="searchdeletedepartures.php">Back</a></li>
</form>
</ul>
</div>
<!-- .navbar-collapse --></div>
			...
			<div class="col-md-12 col-sm-12">
				<div class="service-box3">
					 <div class="container-fluid" >
							...
							<form action="departuresdeleteSubmit.php" method="POST">
...
<div class="row">
<div class="col-sm-12">
<h2>How to delete for Departures?</h2>

<p>Please look if you want to delete the flight consisting the following information.</p>
</div>
</div>
</div>
</section>
