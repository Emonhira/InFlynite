...
<section class="services service-style2" id="features">
	<div class="container">
		<div class="row">
			...
			<h2 class="featurehead">Employees</h2>
			</div>
	 ...
	 <!--table-->
					...
					<table class = "employees-table" style="margin: 0 auto;">
						  <tr style="border-bottom: 2px solid white;">
							<th style="padding-right:70px;padding-bottom: 2px;padding-left:50px;color:#ef494d;">Employee_ID</th>
							<th style="padding-right:120px;color: #ef494d">Name</th>
							<th style="padding-right:140px;color: #ef494d;">Contact</th>
							<th style="padding-right:150px;color: #ef494d;">Address</th>
							<th style="padding-right:120px;color: #ef494d;">Airlines</th>
						  </tr>
						  <?php include('employeestable2.php');?>			 
					  </table>
					</div>
				</div>
			</div>
...
<div id="id01" class="modal">
					<form class="modal-content3 animate" action="/action_page.php">
						...
						<div class="container">
								  <h1 style="text-decoration:none;">Manage employees</h1>
								  <p style="font-size:25px;margin-left: 20px !important;"><b>Add a employer info to the table!</b></p>
								  <a href="employees2.php" class="insertbtn" style="text-decoration:none;background-color:white;color:#ef494d;margin-left: 20px !important;border:1px solid white;padding:10px;"><b>Insert</b></a>
								  <div><p style="font-size:25px;margin-left: 20px !important;"><b>Or you could search employee info to edit or delete!</b></p></div>
								  <a href="searchpageemployees.php" style="text-decoration:none;background-color:white;margin-left: 20px !important;color:#ef494d;border:1px solid white;padding:10px;" class="insertbtn"><b>Edit</b></a>&nbsp;
								  <a href="searchdeleteemployees.php" style="text-decoration:none;background-color:white;color:#ef494d;border:1px solid white;padding:10px;" class="insertbtn"><b>Delete</b></a><br>
								</div>
								<br>
...
<div class="row">
    <div class="col-lg-12" align="center">
		<button class="btn btn-lg btn-success center text-center" style="border-radius: 8px;" id="btnContactUs" onclick="document.getElementById('id01').style.display='block'">Manage</button>
	</div>
</div>
</div>
</section>
...
<div class="row">
<div class="col-sm-12">
<h2 style="position:relative;">How to manage employees?</h2>

<p style="position:relative;font-size: 18px;">Please make sure you type in the exact employee name,  email, contact and airlines respectively. They must be precise according to the International Aviation Rules</p>
</div>
</div>
</div>
</section>
