			...
			<div class="col-md-12 col-sm-12">
				<div class="service-box3">
					 <div class="container-fluid" >
							...
							<label>TIME: </label>
							 <input type="text" placeholder="Enter Flight Time.." name="fatimes" style="margin-left: 170px;border-radius: 5px;"required>
							  <br>
							<label>FLIGHT NUMBER: </label>
							<input type="text" placeholder="Enter Flight Number.." name="fano" style="margin-left: 60px;border-radius: 5px;" required>
							  <br>
							<label>DESTINATION: </label>
							<input type="text" placeholder="Enter Arriving flight.." style="margin-left: 86px;border-radius: 5px;" name="fadest" required>
							  <br>
							<label>GATE: </label>
							<input type="text" placeholder="Enter Gate Number" style="margin-left: 168px;border-radius: 5px;" name="fagate" required>
							<br> 							  
							<label>FLIGHT STATUS: </label>
							<input type="text" placeholder="Enter Flight Status" style="margin-left: 75px;border-radius: 5px;" name="fastatus" required>
							<br>
							  <button type="submit" style="margin-left: 1100px;" name="arrivalsend" class="savebtn">Save</button>
							</div>								
								</form>
							</div>
                  			  </div>
...
<div class="container">
	<div class="row">
	<div class="col-sm-12">
	<h2 style="position:relative;">How to insert flights for arrivals?</h2>

	<p style="position:relative;font-size:18px;">Please fill up all the necessary fields shown above regarding the details of the flights arriving at the airports.</p>
	</div>
</div>
</div>
</section>
