			...
			<div class="col-md-12 col-sm-12">
				<div class="service-box3">
					 <div class="container-fluid" >
							...
							<form action="passengersinsert.php" method="POST">
							<label>Name: </label>
							<input type="text" placeholder="Enter passenger name.." style="margin-left: 170px;border-radius: 5px;" name="pname"  required>
							  <br>
							<label>Age: </label>
							<input type="text" placeholder="Enter passenger's age.." style="margin-left: 185px;border-radius: 5px;" name="page" required>
							  <br>
							<label>Email: </label>
							<input type="text" placeholder="Enter passenger's email..." style="margin-left: 170px;border-radius: 5px;" name="pemail" required>
								<br>						  
							<label>Date: </label>
							<input type="date" placeholder="Enter departuring date..." style="margin-left: 174px;border-radius: 5px;" name="pdate" required>
								<br>							  
							<label>Ticket Number: </label>
							<input type="text" placeholder="Enter ticket number...." style="margin-left: 85px;border-radius: 5px;" name="pticket" required>
							  <br>
							  <label>Flight Number: </label>
							<input type="text" placeholder="Enter flight number...." style="margin-left: 88px;border-radius: 5px;" name="pflight" required>
							  <br>
							  <label>Flight Time: </label>
							<input type="text" placeholder="Enter flight time...."  style="margin-left: 116px;border-radius: 5px;"name="pflighttime" required>
							  <br>
							  <label>Airlines: </label>
							<input type="text" placeholder="Enter airline name...." style="margin-left: 145px;border-radius: 5px;"name="pairlines" required>
							  <br>
							  <label>To: </label>
							<input type="text" placeholder="Enter destination...."  style="margin-left: 192px;border-radius: 5px;" name="pto" required>
							  <br>
								<div class="row">
								<div class="col-lg-12" align="center">
								<button type="submit" name="arrivalsend" style="margin-left: 1100px;" class="savebtn">Save</button>
								</div>	
								</div>
							</div>							
								</form>
...
<div class="row">
<div class="col-sm-12">
<h2 style="position:relative;">How to insert information about passengers?</h2>

<p style="position:relative; font-size:18px;">Please fill up all the necessary fields shown above regarding the details of the passengers who are leaving and entering the airports.</p>
</div>
</div>
</div>
</section>
