...
<section class="intro2 intro2-style2">
	...
	<h1 id="beadriverformtexthead" style="color:black;font-weight:450;" >Search<span style="color:white;">inFlynite</span> amount of <br> flights altogether right where<br> you are!</h1><br><br>
	<a href="searchArrivalTable.php" class="arrival" style="font-size:55px;margin-left:5px;color:#f4f4f4;text-decoration: none;">Arrivals |</a>
	<a href="searchDepartureTable.php" class="departure" style="font-size:55px;color:#195387;text-decoration: none;">Departures</a>
	</div>
	</div>
	</div>
</section>
