...
<ul class="nav navbar-nav navbar-right">
	...
	<li class="nav-download-btn"><a href="departure.php">Back</a></li>
</form>
</ul>
</div>
<!-- .navbar-collapse --></div>
			...
			<div class="col-md-12 col-sm-12">
				<div class="service-box3">
					 <div class="container-fluid" >
							...
							<div class="dropdown">
							<form action="departuresdelete.php" method="POST">
...
<div class="row">
<div class="col-sm-12">
<h2>How to delete a departing flight?</h2>

<p>Please enter your flight number to search it for deleting afterwards.</p>
</div>
</div>
</div>
</section>
