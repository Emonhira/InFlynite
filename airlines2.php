...
<ul class="nav navbar-nav navbar-right">
	...
	<li class="nav-download-btn"><a href="airlines.php">Back</a></li>
</form>
</ul>
</div>
<!-- .navbar-collapse --></div>
			...
			<div class="col-md-12 col-sm-12">
				<div class="service-box3">
					 <div class="container-fluid" >
							...
							<form action="airlinesinsert.php" method="POST">
							<label>AIRLINE: </label>
							 <input type="text" placeholder="Enter flight time.." name="aline" style="margin-left: 100px;"required>
							  <br>
							<label>AIRLINE CONTACT: </label>
							<input type="text" placeholder="Enter flight number.." name="aco" style="margin-left: 100px;" required>
							  <br>
							<label>COUNTRY: </label>
							<input type="text" placeholder="Enter flight arriving from.." style="margin-left: 100px;" name="acon" required>
							  <br>
							<label>AIRLINE HUB: </label>
							<input type="text" placeholder="Enter gate number" style="margin-left: 100px;" name="ahub" required>
								<br>							  
...
<div class="row">
<div class="col-sm-12">
<h2>How to insert airlines?</h2>

<p>Please fill up all the necessary fields shown above regarding the details of the airlines leaving and entering the airports.</p>
</div>
</div>
</div>
</section>
