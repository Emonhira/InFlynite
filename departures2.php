			...
			<div class="col-md-12 col-sm-12">
				<div class="service-box3">
					 <div class="container-fluid" >
							...
							<form action="departureinsert.php" method="POST">
							<label>TIME: </label>
...
<div class="row">
<div class="col-sm-12">
<h2 style="position:relative;">How to insert for departures?</h2>

<p style="position:relative;font-size:18px;">Please fill up all the necessary fields shown above regarding the details of the flights leaving from the airports.</p>
</div>
</div>
</div>
</section>
