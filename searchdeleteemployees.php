...
<ul class="nav navbar-nav navbar-right">
	...
	<li class="nav-download-btn"><a href="employeestable.php">Back</a></li>
</form>
</ul>
</div>
<!-- .navbar-collapse --></div>
			...
			<div class="col-md-12 col-sm-12">
				<div class="service-box3">
					 <div class="container-fluid" >
							...
							<div class="dropdown">
							<form action="employeesdeletesubmit.php" method="POST">
							<br>
						    <label style="margin-left:300px;">Employee Name: </label>
							 <input style="margin-left:300px;" type="text" placeholder="Enter name.." name="ename" style="margin-left: 150px;"required>
							<br>
...
<div class="row">
<div class="col-sm-12">
<h2>How to remove employees?</h2>

<p>Please remove any employee you think is necessary from the table.</p>
</div>
</div>
</div>
</section>
