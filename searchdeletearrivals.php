				...
				<div class="service-box3">
					 <div class="container-fluid" >
						    ...
						    <label style="margin-left:200px;">Flight No: </label>
							 <input style="margin-left:200px;"  type="text" placeholder="Enter flight no.." name="flight" style="margin-left: 150px;"required>
							<br>
...
<p style="position:relative;font-size:18px;">Please enter your flight number to search it for deleting afterwards.</p>
</div>
</div>
</div>
</section>
