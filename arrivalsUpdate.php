...
<section class="services service-style2" id="features">
	<div class="container">
		<div class="row">
			...
			<h2 class="featurehead">Update Flight Info</h2>
			</div>
			...
			<div class="col-md-12 col-sm-12">
				<div class="service-box3">
					 <div class="container-fluid" >
							...
							<form action="arrivalsUpdateSubmit.php" method="POST">
							...
							<input type="text" placeholder="Enter flight status" value="<?php echo $flightStatus ?>" style="margin-left: 75px;border-radius: 5px;" name="fastatus" required>
							 ...
							 <input type="hidden" placeholder="Original Flight No." value="<?php echo $originalFlightNo ?>" name="originalFlight" >
							  ...
							  <button type="submit" name="arrivalsend" class="savebtn" style="margin-left: 1100px;">Update</button>
							</div>								
								</form>
							</div>
                    </div>
...
<div class="row">
<div class="col-sm-12">
<h2 style="position:relative;">How to update flights for Arrivals?</h2>

<p style="position:relative;font-size:18px;">Please make changes to the flight details wherever you think is necessary for passengers to know about their flights.</p>
</div>
</div>
</div>
</section>
