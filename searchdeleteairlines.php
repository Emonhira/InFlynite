			...
			<div class="col-md-12 col-sm-12">
				<div class="service-box3">
					 <div class="container-fluid" >
							...
							<div class="dropdown">
							<form action="airlinesdeletesubmit.php" method="POST">
							<br>
							...
							<br>
							  <button style="margin-left:450px;" type="submit" name="arrivalsend" class="savebtn">Delete</button>
							</div>								
								</form>
							</div>
                    </div>
...
<div class="row">
<div class="col-sm-12">
<h2>How to remove airlines from the table?</h2>

<p>Please remove any specific airline information if you have to.</p>
</div>
</div>
</div>
</section>
