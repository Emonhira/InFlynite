				...
				<div class="service-box3">
					 <div class="container-fluid" >
						    ...
						    <label  style="margin-left:200px;">Passenger Name: </label>
							 <input style="margin-left:200px;"type="text" placeholder="Enter name.." name="passenger" style="margin-left: 150px;"required>
							<br>
							  <button  style="margin-left:300px;" type="submit" name="arrivalsend" class="savebtn">Delete</button>
							</div>								
								</form>
							</div>
                    </div>
...
<div class="row">
<div class="col-sm-12">
<h2 style="position:relative;">How to remove passengers from the table?</h2>

<p style="position:relative;font-size:18px;">Please press delete to remove any passenger you need to from the table.</p>
</div>
</div>
</div>
</section>
