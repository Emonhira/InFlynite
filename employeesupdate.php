...
<ul class="nav navbar-nav navbar-right">
	...
	<li class="nav-download-btn"><a href="searchpageemployees.php">Back</a></li>
</form>
</ul>
</div>
<!-- .navbar-collapse --></div>
...
<?php
					...
					$originalFlightNo = $_POST['ename'];
					$sql="SELECT * FROM employee WHERE employee_name='{$originalFlightNo}'";

					$result = mysqli_query($con,$sql);
					$row=mysqli_fetch_array($result);
					
					
					$time = $row['employee_contact'];
					$destination = $row['employee_address'];
					$gate = $row['employee_airlines'];
...
<section class="services service-style2" id="features">
	<div class="container">
		<div class="row">
			...
			<h2 class="featurehead">Update Employees Info</h2>
			</div>
			...
			<div class="col-md-12 col-sm-12">
				<div class="service-box3">
					 <div class="container-fluid" >
							...
							<form action="employeesupdatesubmit.php" method="POST">
...
<div class="row">
<div class="col-sm-12">
<h2>How to update information about employees</h2>

<p>Please make changes to the details of the employee wherever you think is necessary.</p>
</div>
</div>
</div>
</section>
