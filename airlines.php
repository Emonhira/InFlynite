...
<section class="services service-style2" id="features">
	<div class="container">
		<div class="row">
			...
			<h2 class="featurehead">Airlines</h2>
			</div>
	 ...
	 <!--table-->
					...
					<table  class="passengers-table" style="margin: 0 auto;">
						  <tr  style="border-bottom: 2px solid white;">
							<th style="padding-right:30px;;padding-left:50px;color: #ef494d;">Airline ID</th>
							<th style="padding-right:90px;color: #ef494d;">Airline Name</th>
							<th style="padding-right:70px;color: #ef494d;">Airline Contact</th>
							<th style="padding-right:70px;color: #ef494d;">Airline Country</th>
							<th style="padding-right:70px;color: #ef494d;">Airline Hub</th>
						  </tr>
						<?php include('airlinestable2.php');?>
					  </table>
					</div>
				</div>
			</div>
...
<div id="id01" class="modal">
					<form class="modal-content3 animate" action="/action_page.php">
						...
						<div class="container">
								  ...
								  <a href="airlines2.php" class="insertbtn" style="text-decoration:none;background-color:white;color:#ef494d;margin-left: 20px !important;border:1px solid white;padding:10px;"><b>Insert</b></a>
								  <div><p style="font-size:25px;margin-left: 20px !important;"><b>Or you could search your flight to edit or delete!</b></p></div>
								  <a href="searchpageairlines.php" style="text-decoration:none;background-color:white;margin-left: 20px !important;color:#ef494d;border:1px solid white;padding:10px;" class="insertbtn"><b>Edit</b></a>&nbsp;
								  <a href="searchdeleteairlines.php" style="text-decoration:none;background-color:white;color:#ef494d;border:1px solid white;padding:10px;" class="insertbtn"><b>Delete</b></a><br>
								</div>
								<br>
...
<div class="container">
<h2 style="position:relative;">How to manage information about airlines?</h2>

<p style="position:relative;font-size:18px;">Please fill up all the necessary fields shown above regarding the details of the airlines leaving and entering the airports as per say of the International Aviation Rule.</p>
</div>
</section>
<!-- Ends: .information -->
