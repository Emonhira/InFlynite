			...
			<div class="container">
                        ...
                        <div class="collapse navbar-collapse navbar-morki">
                            <ul class="nav navbar-nav navbar-right navbar-edit">
                                ...
                                <li><a href="searchArrivalTable.php" class="loginButton" style="background-color:#ef494d;border-radius:6px;padding: 10px;">Back</a></li>		
							</ul>
                        </div><!-- .navbar-collapse -->		
			</div>
		</nav>
			...
			<div class="col-md-12 col-sm-12">
				<div class="service-box3">
					 <div class="container-fluid" >
							<div class="container" style="border: 8px solid #ef494d;background-color: #ef494d;border-radius: 25px;width: 800px;margin: 0 auto;">
                                <table style="margin: 0 auto;">
                                    ...
                                    <?php
                                        $sql2 = "SELECT * FROM flights WHERE Flight_No='".$flight."'";
