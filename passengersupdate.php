...
<section class="services service-style2" id="features">
	<div class="container">
		<div class="row">
			...
			<h2 class="featurehead">Update Passengers Info</h2>
			</div>
			...
			<div class="col-md-12 col-sm-12">
				<div class="service-box3">
					 <div class="container-fluid" >
							...
							<form action="passengersUpdateSubmit.php" method="POST">
...
<div class="row">
<div class="col-sm-12">
<h2 style="position:relative;">How to update passenger details?</h2>

<p style="position:relative;font-size:18px;">Please make changes to the details wherever you think is necessary for passengers information.</p>
</div>
</div>
</div>
</section>
