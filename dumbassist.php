...
<section class="services service-style2">
	<div class="container">
		<div class="row">
			...
			<h2 class="featurehead" style="margin-bottom:-100px;">Dumb Assistance</h2>
			</div>
        </div>
        <br><br> <br><br> <br><br>
        <div style="text-align:center;">
            ...
            <br>
            <div><img id="decoy-image" src="./images/loc3.gif" style="display:block;width:600px;height:500px;border-radius:10px;margin: 0 auto;" ></div>
