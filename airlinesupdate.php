...
<ul class="nav navbar-nav navbar-right">
	...
	<li class="nav-download-btn"><a href="searchpageairlines.php">Back</a></li>
</form>
</ul>
</div>
<!-- .navbar-collapse --></div>
...
<?php
					...
					$originalFlightNo = $_POST['aname'];
					$sql="SELECT * FROM airlines WHERE Airline_Name='{$originalFlightNo}'";

					$result = mysqli_query($con,$sql);
					$row=mysqli_fetch_array($result);
					
					
					$time = $row['Airline_Contact'];
					$destination = $row['Airline_Country'];
					$gate = $row['Airline_Hub'];
...
<section class="services service-style2" id="features">
	<div class="container">
		<div class="row">
			...
			<h2 class="featurehead">Update Airlines Info</h2>
			</div>
			...
			<div class="col-md-12 col-sm-12">
				<div class="service-box3">
					 <div class="container-fluid" >
							...
							<form action="airlinesupdatesubmit.php" method="POST">
...
<div class="row">
<div class="col-sm-12">
<h2>How to update information about airlines?</h2>

<p>Please make changes where necessary regarding the details of the airlines arriving and leaving from the airports.</p>
</div>
</div>
</div>
</section>
