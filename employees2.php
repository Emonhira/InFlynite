			...
			<div class="container">
                        ...
                        <div class="collapse navbar-collapse navbar-morki">
                            <ul class="nav navbar-nav navbar-right navbar-edit">
                                ...
                                <li><a href="employeestable.php" class="loginButton" style="background-color:#ef494d;border-radius:6px;padding: 10px;">Back</a></li>		
							</ul>
                        </div><!-- .navbar-collapse -->		
			</div>
		</nav>
			...
			<div class="col-md-12 col-sm-12">
				<div class="service-box3">
					 <div class="container-fluid" >
							...
							<label>NAME: </label>
							<input type="text" placeholder="Enter employee name.." name="ename" style="margin-left: 72px;border-radius: 5px;" required>
							  <br>
							<label>CONTACT: </label>
							<input type="text" placeholder="Enter employee's contact number.." style="margin-left: 40px;border-radius: 5px;" name="econt" required>
							  <br>
							<label>ADDRESS: </label>
							<input type="text" placeholder="Enter employee's address..." style="margin-left: 40px;border-radius: 5px;" name="eaddress" required>
								<br>							  
							<label>AIRLINES: </label>
							<input type="text" placeholder="Enter the airline working on...." style="margin-left: 42px;border-radius: 5px;" name="eairlines" required>
							  <br><br>
							  <button style="margin-left: 1100px;" type="submit" name="arrivalsend" class="savebtn">Save</button>
							</div>								
								</form>
							</div>
                    </div>
...
<div class="row">
<div class="col-sm-12">
<h2 style="position:relative;">How to insert information about employees?</h2>

<p style="position:relative;font-size:18px;">Please fill up all the necessary fields shown above regarding the details of the employees leaving and entering the airports</p>
</div>
</div>
</div>
</section>
